            ...
            <div className="place-order-right">
                <div className="cart-total">
                    ...
                    <div>
                        ...
                        <hr />
                        <div className="cart-total-details"><p>Delivery Fee</p><p>₹{getTotalCartAmount() === 0 ? 0 : 37}</p></div>
                        <hr />
                        <div className="cart-total-details"><b>Total</b><b>₹{getTotalCartAmount() === 0 ? 0 : getTotalCartAmount() + 37}</b></div>
                    </div>
                </div>
